...
function Home() {
    ...
    return (
        ...
        <section id="coverImage">
            ...
            <div id="font">
                <h1 id="cover">MENTAL<br>HEALTH</h1><br>
            </div>
            <div>
       ...
       <section class="copy">
        ...
        <section id="section3">
            <div class="cards">
                <img src="Assets/tom-the-photographer-ByqC3ko_sQY-unsplash.jpeg">
                <h3>Get Help</h3>
            ...
            <div class="cards">
                <img src="Assets/anthony-tran-vXymirxr5ac-unsplash.jpeg">
                <h3>Warning Signs</h3>
            ...
            <div class="cards">
                <img src="Assets/priscilla-du-preez-F9DFuJoS9EU-unsplash.jpeg">
                <h3>How To Help</h3>
